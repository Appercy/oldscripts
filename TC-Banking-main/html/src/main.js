  ...
  semantic: {
      ...
      overlay: {
          ...
          popover: {
            ...
            borderColor: "transparent", // Optional: Adjust border color
            color: "#8b0000", // Optional: Set text color for contrast
          },
          modal: {
              borderRadius: "{border.radius.xs}",
              padding: "1.25rem",
...
// Removed unused naive-ui imports and initialization
